Feature: Login
  ...
  Scenario Outline: Login — Flow 2
    ...
    Examples:
      | TC_ID | Username | Password | Fromaccountid | Toaccountid | Amount | Transfer_expected |
      | TC02 | john | demo | first | second account | 100 | Transfer Complete |
  ...
  Scenario Outline: Login — Flow 3
    ...
    Then I verify "Send Payment" shows "<Send_Payment_expected>"

    Examples:
      | TC_ID | Username | Password | Payee.name | Customer.address.city | Amount | Send_Payment_expected |
